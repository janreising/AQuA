...
class EventDetector:
    ...
    def run(self, dataset=None,
            ...
            binary_struct_iterations=1, binary_struct_connectivity=2,
            output_folder=None):
    ...
    def get_events(self, data: np.array, roi_threshold: float, var_estimate: float,
                   ...
                   binary_struct_iterations=1, binary_struct_connectivity=2) -> (np.array, dict):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--binarystruct", type=int, default=1)
    parser.add_argument("-c", "--binaryconnect", type=int, default=2)
    ...
    for key in keys:
        ...
        ed.run(dataset=key, threshold=args.threshold, use_dask=use_dask, subset=subset,
               ...
               binary_struct_connectivity=args.binaryconnect, binary_struct_iterations=args.binarystruct)
