...
opts.legacyModeActRun = 0; % Older code for active voxels
...
fprintf("\nStarting to save ... \n");
tic;
save_to_h5(h5_path, datOrg, '/res/datOrg');  % original data
save_to_h5(h5_path, opts, '/res/opts');
save_to_h5(h5_path, evtLstE, '/res/evt');
save_to_h5(h5_path, ftsLstE, '/res/fts');
save_to_h5(h5_path, dffMatE, '/res/dffMat');  % dFF matrix
save_to_h5(h5_path, dMatE, '/res/dMat');  % ? weird dimensions
